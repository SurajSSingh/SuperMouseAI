// Adapted from https://github.com/huntabyte/shadcn-svelte/blob/next/sites/docs/src/lib/utils.ts
// Used under MIT License, see https://github.com/huntabyte/shadcn-svelte/blob/next/LICENSE.md
